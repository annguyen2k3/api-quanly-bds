...
const staff_validate_1 = require("../validates/staff.validate");
const staffSchema_1 = require("../validates/staffSchema");
router.get("/detail/:nvid", authMiddleware.protectRoute, authMiddleware.isAdmin, controller.detail);
router.post("/create", authMiddleware.protectRoute, authMiddleware.isAdmin, (0, staff_validate_1.validateData)(staffSchema_1.staffSchema), controller.create);
